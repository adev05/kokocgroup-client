...
export default function NewsLoadingCard() {
	return (
		<div
			className='w-full flex flex-col justify-start overflow-hidden cursor-pointer border rounded-3xl relative hover:[transform:scale(1.025)] [transition:transform_0.25s] p-2 pb-4 space-y-4'
			draggable={false}
		>
